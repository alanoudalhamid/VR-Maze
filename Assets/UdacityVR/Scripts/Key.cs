...
public class Key : MonoBehaviour {
	...
	void Update () {
        ...
        gameObject.transform.Rotate( 0f, 0f, Time.deltaTime * 200);
	...
	public void OnKeyClicked () {
        ...
        GameObject keyClone = (GameObject)Instantiate(KeyPoofPrefab, transform.position, Quaternion.Euler(KeyPoofPrefab.transform.rotation.x, KeyPoofPrefab.transform.rotation.y, KeyPoofPrefab.transform.rotation.z));
